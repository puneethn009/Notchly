...
#ifndef NOTCHAPP_SWIFT_H
#define NOTCHAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NotchApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8NotchApp11AppDelegate")
...
SWIFT_CLASS("_TtC8NotchApp10NotchPanel")
...
SWIFT_CLASS("_TtC8NotchApp10NotchState")
@interface NotchState : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSCoder;
@class NSWindow;
SWIFT_CLASS("_TtC8NotchApp21NotchWindowController")
...
SWIFT_CLASS("_TtC8NotchApp26NotchlyHubWindowController")
@interface NotchlyHubWindowController : NSWindowController
- (nonnull instancetype)initWithWindow:(NSWindow * _Nullable)window OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC8NotchApp23PreviewWindowController")
...
SWIFT_CLASS("_TtC8NotchApp32ScreenshotEditorWindowController")
@interface ScreenshotEditorWindowController : NSWindowController
- (nonnull instancetype)initWithWindow:(NSWindow * _Nullable)window OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC8NotchApp27ScreenshotPreviewController")
@interface ScreenshotPreviewController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
